...
/**
 ...
 as `-[MGLMapView setCamera:animated:]`. It can be called before the map view 
 has finished loading. During the animation, this method may be called many 
 times to report updates to the viewpoint. Therefore, your implementation of this 
 method should be as lightweight as possible to avoid affecting performance.
...
/**
 ...
 can be called before the map view has finished loading.
